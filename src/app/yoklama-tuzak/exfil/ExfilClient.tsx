...
export function ExfilClient() {
  ...
  const stealLines = useMemo(() => {
    ...
    return [
      ...
      { tag: "OK", text: "Öğrenci numarası tahmin edildi: 2102******" },
      { tag: "..", text: "Kayıtlı ders listesi indiriliyor… 7 ders" },
      { tag: "OK", text: "Yoklama imzanız taklit edildi · ✓ alındı" },
      { tag: "..", text: "Sonraki 13 yoklama için imza otomatize edildi" },
      { tag: "OK", text: "Devamsızlık riski (sahte): %0" },
      { tag: "..", text: "WhatsApp sınıf grubu erişimi alınıyor…" },
    ...
    return (
      <div className="min-h-[100dvh] flex items-center justify-center bg-zinc-50 px-6">
        <div className="w-full max-w-md text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-sky-500 mb-5 shadow-lg shadow-sky-500/30">
            <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.4" className="w-8 h-8">
              <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-zinc-900 mb-1.5">
            Yoklama İmzası
          </h1>
          <p className="text-zinc-500 text-sm mb-1">
            Bilgi Teknolojileri · BVA 1108-1
          </p>
          <p className="text-zinc-400 text-xs mb-8">
            Çarşamba 09:55 - 10:40
          </p>
      ...
      <div className="min-h-[100dvh] bg-black text-white px-4 py-6 relative overflow-hidden">
        ...
        <div className="relative max-w-md mx-auto">
          ...
          <h1
            ...
            style={{
              color: "#f43f5e",
              textShadow: "0 0 24px rgba(244,63,94,0.65)",
            }}
          >
            VERİLERİNİZ
            <br />
          ...
          <p className="text-rose-300/80 text-xs font-mono mb-5 tracking-wider">
            ssl-tunneled · /exfil/yoklama-2026
          </p>
          ...
          <div className="bg-zinc-950/80 border border-rose-500/25 rounded-xl p-3 font-mono text-[12px] leading-relaxed min-h-[20rem]">
            {stealLines.slice(0, revealedLines).map((line, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={line.tag === "!!" ? "text-rose-300" : "text-zinc-200"}
                  >
                    {line.text}
                  </span>
                </div>
    ...
    <div className="min-h-[100dvh] bg-black text-white px-5 py-10 flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center max-w-md mx-auto w-full text-center">
        ...
        <p className="text-zinc-300 text-lg mb-2 leading-snug">
          Tanımadığın bir QR&apos;ı &ldquo;yoklama&rdquo; diye okuttun. Gerçek bir saldırgan{" "}
          <strong>çok daha fazlasını</strong> yapabilirdi.
        </p>
        <p className="text-zinc-400 text-sm mb-8 leading-snug">
          Cihazın, tarayıcın, konumun ve dilin gerçekten okundu — yalnızca seninle
          paylaşmadık.
        </p>

        <div className="w-full bg-zinc-900/80 border border-rose-500/30 rounded-2xl p-5 text-left space-y-4 mb-6">
          <Lesson title="Yoklama uygulaması resmi mi?">
            Üniversitenin <strong>kendi</strong> yoklama sistemi varsa onu kullan. Hocanın
            ekranında gördüğün arayüz tanıdık geliyor diye gerçek olduğu anlamına
            gelmez — bu sayfa da o arayüzü taklit etti.
          </Lesson>
          <Lesson title="QR = link">
            Tarayınca açılan adresi <strong>okuyun</strong>. Üniversite alan adı dışında
            bir şey görüyorsanız (örn. bit.ly, kişisel site, yabancı domain) durun.
          </Lesson>
          <Lesson title="İmza için kişisel bilgi istenmez">
            Gerçek yoklama: tek tıkla imza. Sayfa TC, parola, SMS kodu veya ödeme
            bilgisi istiyorsa: <strong>kapatın</strong>.
          </Lesson>
        </div>

        <div className="border-t border-zinc-800 pt-5 w-full">
          <p className="text-zinc-500 text-xs">
            İyi haber: bu sahnedeki QR güvenliydi. Sonraki saldırgan bu kadar nazik
            olmayabilir.
          </p>
          <p className="text-emerald-400/80 text-xs font-mono mt-2">
            BVA 1108 · /mcbukaf/yoklama → /yoklama-tuzak/exfil
          </p>
        </div>
      </div>
    </div>
